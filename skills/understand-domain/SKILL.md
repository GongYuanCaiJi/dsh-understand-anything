...
# <plugin-root>/skills/understand-domain; the plugin root is two directories
# above the skill's base directory (the harness reports it as the skill's
# base directory — substitute it for <SKILL_DIR> here).
